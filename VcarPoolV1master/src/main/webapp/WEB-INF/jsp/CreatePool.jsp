  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item active">
          <a class="nav-link" href="Createpool.vcp">Home
      ...
      // System.out.println(sqlDate);
       ...
       /* PreparedStatement pst=con.prepareStatement("select * from UserRegister where EmployeeId=?");
        ...
        <li class="nav-item dropdown ">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><b><%=name%></b></a> 
...
-->
<form onsubmit="return validateSTime() && validateRTime() && validate()" action="CreatePoolController.vcp">
	...
	<div class="container h-100">
		...
		<div class="row h-100 align-items-center">
			...
			<div class="col-12 text-center">
				...
				</br></br></br><h2 class="font-weight-light"><u>Please fill the details for provide pool</u></h2></br>	</br><br>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="origin-input" placeholder="From" name="source" required="required">
				
					</div>
				
						<div class="form-group">
    					
					<input type="text" class="form-control" id="destination-input" placeholder="To" name="destination" required="required">
				...
				<div class="form-group">
								...
								<select class="form-control" id="txtNoOfSeats" name="noOfSeats" onchange="OnSelectInput" >
							...
							<input type="hidden" name="currentDate" value=<%=currentDate %>>
								 ...
								 <button type="submit"  class="btn btn-primary">Provide Ride</button>

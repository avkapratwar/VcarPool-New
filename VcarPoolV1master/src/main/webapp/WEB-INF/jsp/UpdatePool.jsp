...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC1aVjwZ4ShO2OVhPQA6A0G48H5FdXy6tc&libraries=places&callback=initMap"
        async defer></script>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item active">
          <a class="nav-link" href="ProviderHomePage.jsp">Home
       ...
       <li class="nav-item dropdown ">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><b><%=employee.getEmployeeName()%></b></a> 
...
<form method="post" onsubmit="return validate()" action="CreatePoolController.vcp">
	...
	<div class="container h-100">
		...
		<div class="row h-100 align-items-center">
			...
			<div class="col-12 text-center">
				...
				</br></br><h2 class="font-weight-light"><u>Update the Pool</u></h2>	</br><br>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="origin-input" value="<%=provider.getSource() %>" name="source" required="required">
				
					</div>
				
						<div class="form-group">
    					
					<input type="text" class="form-control" id="destination-input" value="<%=provider.getDestination() %>" name="destination" required="required">
			
						</div>
						
						 <div class="form-group">
    
						<select class="form-control" id="input3" name = "startTime" onchange="OnSelectInput">
					...
					<div class="form-group">
							...
							<select class="form-control" id="input4" name = "returnTime" onchange="OnSelectInput">
				...
				<div class="form-group">
								...
								<select class="form-control" id="txtNoOfSeats" name="noOfSeats" onchange="OnSelectInput" value="<%=provider.getNoOfSeats() %>">
							...
							<div class="form-group">
								...
								<select class="form-control" id="input5"  name="status" value="<%=provider.getStatus() %>">
								<option  value="Active">Active</option>
								<option  value="Deactive" >Deactive</option>
							
							</select>
							<input type="hidden" name="employeeId" value=<%=employee.getEmployeeId() %>>
							<input type="hidden" name="poolId" value=<%=provider.getPoolId() %>>
							<input type="hidden" name="currentDate" value=<%=provider.getCurrentDate() %>>
